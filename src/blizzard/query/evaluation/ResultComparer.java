...
public class ResultComparer {
	...
	protected ArrayList<Integer> getSelectedBugs(String proposedQEFile) {
		ArrayList<String> lines = ContentLoader.getAllLinesOptList(proposedQEFile);
	...
	protected HashMap<Integer, Integer> loadQE(String toolRankFile) {
		ArrayList<String> lines = ContentLoader.getAllLinesOptList(toolRankFile);
	...
	public void compareResults() {
		...
		System.out.println("Improved: " + improved + "/" + selectedBugs.size() + " =  " + this.improvedRatio);
		System.out.println("Worsened: " + worsened + "/" + selectedBugs.size() + " =  " + this.worsenedRatio);
		System.out.println("Preserved: " + preserved + "/" + selectedBugs.size() + " =  " + this.preserved);
