...
import blizzard.utility.QueryLoader;
import blizzard.utility.SelectedBugs;
...
public class BRICKRankProvider {
	...
	public BRICKRankProvider(String repoName, String catKey) {
		...
		this.catKey = catKey;
		this.repoRankFile = StaticData.HOME_DIR + "/Rank/" + repoName + "-" + catKey + ".txt";
		this.selectedBugs = new ArrayList<>();
		this.queryFile = StaticData.HOME_DIR + "/Query/" + repoName + "-" + catKey + ".txt";
	...
	protected void collectBRICKRanks() {
		// collect BRICK ranks
		HashMap<Integer, String> queryMap = QueryLoader.loadQuery(this.queryFile);
	...
	public static void main(String[] args) {
		...
		String catKey = "NL";
		BRICKRankProvider brickRankProvider = new BRICKRankProvider(repoName, catKey);
